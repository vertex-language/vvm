...
// and isel materializes operands through the x0-x7/x9-x15 scratch set, so
// all this pass does is rewrite oSlot operands into FP-relative memory
// operands.
//
// Same deliberate correct-first baseline as lower/x86 and lower/arm: a
// linear-scan allocator (x19-x28 joining the allocatable set, the slot
// becoming the spill home) replaces this function without touching isel's
// output contract. TODO.
